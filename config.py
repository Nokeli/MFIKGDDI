...
#SMILE_HASH = 'obg_2_smile_hash_mix.npy'
SMILE_HASH = 'drugbank_smile_hash.npy'
MOLE_EMBEDDING = 'drugbank_mole_embedding.npy'
#MOLE_EMBEDDING = 'new_obg_2_drugbank_mole_embedding.npy'
MOLE_EMBEDDING = 'kegg_2_drugbank_mole_embedding.npy'
#SELF_EMBEDDING = 'new_obg_2_drugbank_SELF_embedding.npy'
SELF_EMBEDDING = 'kegg_2_drugbank_SELF_embedding.npy'
...
RESULT_LOG={'drugbank':'drugbank_result.txt','kegg':'kegg_result_filed_32.txt','ogb':'ogb_result_filed.txt'}
PERFORMANCE_LOG = 'kegg_performance_filed_32.log'
