...
def generate_negative_samples():
    import pandas as pd
    examples_path = "raw_data/ogb/mix/approved_example_mix.txt"
    ...
    while len(nagative_samples) < len(examples):
        ...
        random_drug = random.randint(10687,10687+2257)
        print(random_drug)

        random_drug1 = random.randint(10687,10687+2257)
        print(random_drug1)
    ...
    print(all_example)
    np.savetxt("raw_data/ogb/approved_example_final.txt", all_example, fmt='%d')
